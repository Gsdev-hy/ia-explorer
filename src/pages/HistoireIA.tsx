...
import { Bot, BookOpen, Brain, Lightbulb, CalendarDays, Award, Milestone, Mail, ExternalLink, Globe, Clock, FileText } from 'lucide-react';
...
const HistoireIA = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {/* Nouvelle section: Publications fondatrices */}
      <div className="mb-12">
      ...
      {/* Section finale: Ressources supplémentaires */}
