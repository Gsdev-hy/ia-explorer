      ...
      <section className="section-container">
        <div className="max-w-5xl mx-auto">
          <SectionHeading
            ...
            description="IA Explorer a été créé avec un objectif clair : rendre l'IA accessible et compréhensible pour le grand public francophone, tout en encourageant une approche réfléchie et éthique de ces technologies."
            center
          />
