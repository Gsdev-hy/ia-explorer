    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/20">
      ...
      <div className="container mx-auto px-4 py-12">
        <Alert className="mb-8">
          ...
          <AlertDescription>
            Ce registre documente tous les traitements de données personnelles effectués par AI Avenir, 
        ...
        <div className="mt-12 text-center text-sm text-muted-foreground">
          ...
          <p className="mt-2">
            ...
            <a href="mailto:dpo@ai-avenir.fr" className="text-primary hover:underline ml-1">
              dpo@ai-avenir.fr
            </a>
          </p>
        </div>
