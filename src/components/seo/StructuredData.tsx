...
export const OrganizationSchema = {
  ...
  "logo": "https://ai-avenir.lovable.app/pics/ia_explorer.jpg",
  "sameAs": [
...
export const WebSiteSchema = {
  ...
  "potentialAction": {
    "@type": "SearchAction",
    "target": "https://ai-avenir.lovable.app/ressources?q={search_term_string}",
...
export const createArticleSchema = (title: string, description: string, author = "Geoffroy Streit", datePublished?: string, dateModified?: string) => ({
  ...
  "publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://ai-avenir.lovable.app/pics/ia_explorer.jpg"
    }
  },
...
export const createCourseSchema = (name: string, description: string, provider = "AI Avenir") => ({
  "@context": "https://schema.org",
  "@type": "Course",
  "name": name,
  "description": description,
