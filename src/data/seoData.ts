...
export const seoData = {
  // Page d'accueil
  "/": {
    title: "AI Avenir - Guide complet Intelligence Artificielle français",
    description: "Découvrez l'IA facilement avec AI Avenir. Cours, outils gratuits, guides pratiques et ressources pour maîtriser l'intelligence artificielle. Formation IA en français.",
    keywords: "intelligence artificielle, IA, machine learning, cours IA, formation IA, guide IA français, outils IA gratuits",
    ogTitle: "AI Avenir - Maîtrisez l'Intelligence Artificielle",
    ogDescription: "Plateforme française #1 pour apprendre l'IA. Cours interactifs, outils gratuits et communauté d'experts.",
    ogType: "website",
    ogImage: "https://ai-avenir.lovable.app/pics/ia_explorer.jpg",
    ...
    structuredData: {
      ...
      "url": "https://ai-avenir.lovable.app",
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://ai-avenir.lovable.app/search?q={search_term_string}",
  ...
  // Pages principales
  "/niveaux-ia": {
    title: "7 Niveaux d'Intelligence Artificielle Expliqués | AI Avenir",
    ...
    ogImage: "https://ai-avenir.lovable.app/pics/ia_levels.jpg",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "Article",
  ...
  "/types-ia": {
    title: "Types d'IA : LLM, RAG, CNN, NLP - Guide Complet | AI Avenir",
  ...
  "/machine-learning": {
    title: "Machine Learning Expliqué : Guide Complet 2024 | AI Avenir",
  ...
  "/cas-usage": {
    title: "Cas d'Usage IA : Applications Concrètes et Exemples | AI Avenir",
    ...
    ogImage: "https://ai-avenir.lovable.app/pics/usage.jpg"
  },

  "/ethique": {
    title: "Éthique de l'IA : Enjeux et Principes | AI Avenir",
    ...
    ogImage: "https://ai-avenir.lovable.app/pics/ethics.jpg"
  },

  // Pages cours
  "/cours/prompt-engineering": {
    title: "Cours Prompt Engineering : Maîtriser l'Art du Prompt | AI Avenir",
    ...
    ogImage: "https://ai-avenir.lovable.app/pics/assisted-writing.jpg",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "Course",
  ...
  "/cours/ia-creativite": {
    title: "IA et Créativité : Révolutionnez vos Créations | AI Avenir",
    ...
    ogImage: "https://ai-avenir.lovable.app/pics/image-generation.jpg"
  },

  // Pages outils
  "/calculateur-couts-ia": {
    title: "Calculateur Coûts IA - Estimez vos Projets IA | AI Avenir",
  ...
  "/generateur-prompts": {
    title: "Générateur de Prompts IA - Créez des Prompts Parfaits | AI Avenir",
  ...
  "/detecteur-contenu-ia": {
    title: "Détecteur Contenu IA - Analysez le Contenu Généré | AI Avenir",
  ...
  "/test-api-ia": {
    title: "Test API IA - Testez les Meilleurs Modèles IA | AI Avenir",
    ...
    ogImage: "https://ai-avenir.lovable.app/pics/code-generation.jpg"
  },

  "/simulateur-ia": {
    title: "Simulateur IA - Expérimentez avec les Modèles ML | AI Avenir",
  ...
  "/comparateur-modeles-ia": {
    title: "Comparateur Modèles IA - Trouvez le Meilleur Modèle | AI Avenir",
  ...
  // Pages ressources
  "/ressources": {
    title: "Ressources IA : Cours, Outils, Guides Gratuits | AI Avenir",
    ...
    ogImage: "https://ai-avenir.lovable.app/pics/educative.jpg"
  },

  "/les-bases": {
    title: "Bases de l'IA : Comprendre l'Intelligence Artificielle | AI Avenir",
...
export const getSEOData = (pathname: string) => {
  return seoData[pathname as keyof typeof seoData] || {
    title: "AI Avenir - Guide Intelligence Artificielle",
    description: "Découvrez l'intelligence artificielle avec AI Avenir. Formation, outils et ressources pour maîtriser l'IA.",
    keywords: "intelligence artificielle, IA, formation IA, guides IA",
    ogTitle: "AI Avenir - Intelligence Artificielle",
