...
export const useDocumentMeta = (seoData: SEOData) => {
  ...
  useEffect(() => {
    ...
    // Canonical URL
    const canonicalUrl = seoData.canonical || `https://ai-avenir.lovable.app${location.pathname}`;
    ...
    return () => {
      ...
      document.title = 'AI Avenir - Guide complet Intelligence Artificielle français';
    };
